    ...
    <form class="form form-horizontal" enctype="multipart/form-data" id="form-car-add" onsubmit="return false;">
        ...
        <div class="row cl">
            ...
            <div class="col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{ old('brand') }}" placeholder="车牌号" id="articletitle2" name="brand">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">分类：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{ old('class') }}" placeholder="分类" id="class" name="class">
            </div>
        </div>
                <div class="row cl">
