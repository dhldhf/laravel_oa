...
<div class="page-container">
    <form class="form form-horizontal" id="form-service-edit">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'commentdatemin\')}' })" id="commentdatemin" name="submission_time" class="input-text Wdate" value="{{ $service->submission_time }}">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">进展：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{ $service->progress }}" placeholder="维修进行情况" id="进展" name="progress">
            </div>
        </div>
        <div class="row cl">
