        ...
        <form class="form form-horizontal" action="{{ route('login') }}" method="post">
            ...
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    ...
                    <img class="thumbnail captcha" src="{{ captcha_src('flat') }}" onclick="this.src='/captcha/flat?'+Math.random()" title="点击图片重新获取验证码"></div>
            </div>
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    <label for="online">
            ...
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    ...
                    <a href="/" class="btn btn-default radius size-L">&nbsp;取&nbsp;&nbsp;&nbsp;&nbsp;消&nbsp;</a><p>还没账号？<a href="{{ route('users.create') }}">现在注册！</a></p>
                </div>
            </div>
        </form>
        {{--<div class="row cl">--}}
