...
<article class="page-container">
    <form class="form form-horizontal" method="post" action="{{ route('drivers.update',['driver'=>$driver]) }}" enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="file" class="input-text" autocomplete="off" value="{{$driver->logo}}" placeholder="司机头像" id="logo" name="logo">
            </div>
        </div>
        <div class="row cl">
